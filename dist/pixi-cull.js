...
define("simple", ["require", "exports"], function (require, exports) {
    "use strict";
    Object.defineProperty(exports, "__esModule", { value: true });
...
define("spatial-hash", ["require", "exports"], function (require, exports) {
    "use strict";
    Object.defineProperty(exports, "__esModule", { value: true });
    ...
    var SpatialHash = /** @class */ (function () {
        ...
        SpatialHash.prototype.invisible = function () {
            ...
            for (var _i = 0, _a = this.containers; _i < _a.length; _i++) {
                var container = _a[_i];
                var length_4 = container.children.length;
            ...
            if (this.dirtyTest) {
                ...
                for (var _i = 0, _a = this.containers; _i < _a.length; _i++) {
                    ...
                    if (!container.cull.static) {
                        var length_6 = container.children.length;
                ...
                var length_7 = this.elements.length;
                ...
                for (var _b = 0, _c = this.containers; _b < _c.length; _b++) {
                    var container = _c[_b];
                    if (!container.cull.static) {
                        var length_8 = container.children.length;
        ...
        SpatialHash.prototype.stats = function () {
            ...
            for (var _i = 0, _a = this.containers; _i < _a.length; _i++) {
                var list = _a[_i];
                var length_11 = list.children.length;
...
define("index", ["require", "exports", "simple", "spatial-hash"], function (require, exports, simple_1, spatial_hash_1) {
    "use strict";
    Object.defineProperty(exports, "__esModule", { value: true });
    exports.SpatialHash = exports.Simple = void 0;
    Object.defineProperty(exports, "Simple", { enumerable: true, get: function () { return simple_1.Simple; } });
    Object.defineProperty(exports, "SpatialHash", { enumerable: true, get: function () { return spatial_hash_1.SpatialHash; } });
});
